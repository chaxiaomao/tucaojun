...
//微博及订阅设置
	...
	array( "type" => "open"), 
       ...
       array("name" => "输入Feed地址(包含http://)",
            ...
            "std" => "http://feed.feedsky.com/yuansitianxia"),
...
//广告设置
	...
	array(	"name" => "输入首页广告代码",
            ...
            "std" => '<a href="http://yuanssi.com/" target="_blank"><img src="http://img.yuanssi.com/2012/01/660.jpg" alt="Ssmay Theme by yuanssi.com" /></a>'),
	...
	array(	"name" => "输入正文右上角广告代码",
            ...
            "std" => '<a href="http://yuanssi.com/" target="_blank"><img src="http://img.yuanssi.com/2012/01/250-250.jpg" alt="Ssmay Theme by yuanssi.com" /></a>'),
...
<p>当前使用主题: Ssmay |设计者: <a href="http://wanlimm.com" target="_blank">高时银博客</a> | <a href="http://wanlimm" target="_blank">查看主题更新</a> | <a href="http://wanlimm.com/" target="_blank">主题指南（必看）</a></p> 
...
<p><font color=#ff0000> &hearts; </font><strong>自愿捐助</strong>：Ssmay主题目前完全免费，如果能获得些许捐助，放眼天下会更有动力去升级完善主题，为您提供更好的技术支持！</p>

<p>支付宝：gaoshiyin2008@aliyun.com (捐助前，请务必前往 wanlimm.com 与高时银博客取得联系)</p>
